...
# define BLINK(txt,pad) ( blink_visible ? txt : pad )
  ...
  // *********interconnection between atoms.....
  // ***********important see this
  if(Clist.occ()>9)
    {
       
      
       for(int temp2=0; temp2<Clist.occ();temp2++)
	 {
     	  
	   if(Clist[temp2]->bpos1bond == true)
	     {
	       glColor3fv(color_lsu_spirit_gold);
	       cone.render(Clist[temp2]->position,0.3,(Clist[temp2]->ballpos1-Clist[temp2]->position),1);
	     }

	   if(Clist[temp2]->bpos2bond == true)
	     {
	       glColor3fv(color_lsu_spirit_gold);
	       cone.render(Clist[temp2]->position,0.3,(Clist[temp2]->ballpos2-Clist[temp2]->position),1);
	     }
  ...
  if(Clist2.occ()>9)
    {
       ...
       for(int temp2=0; temp2<Clist2.occ();temp2++)
	 {
     	  
	   if(Clist2[temp2]->bpos1bond == true)
	     {
	       glColor3fv(color_lsu_spirit_gold);
	       cone.render(Clist2[temp2]->position,0.3,(Clist2[temp2]->ballpos1-Clist2[temp2]->position),1);
	     }

	   if(Clist2[temp2]->bpos2bond == true)
	     {
	       glColor3fv(color_lsu_spirit_gold);
	       cone.render(Clist2[temp2]->position,0.3,(Clist2[temp2]->ballpos2-Clist2[temp2]->position),1);
	     }
  ...
  //  glColor3fv(color_lsu_spirit_gold);
  // cone.render(Clist[2]->position,0.1,(Clist[2]->position-Clist[9]->position),1);
