...
public:
  ...
  Carbon_List Clist2;
  Ball* ballslist;
  float len_of_nanotube ;
  float breadth_of_nanotube ;
  float opt_spring_constant;
  float dist_bwt_atoms;
  int scene_change;
  ...
  void setup_debug();
  void setup_multinano();
  void setup_diff_nanotube();
  void setup_cnt(int nofballs = 1);
  void setup_nanotube(int dist, int len, int breadth);
  void setup_nanotube_2(int dist, int len, int breadth);
